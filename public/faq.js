  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: {
        title: "Fees",
        content:
          "The fees for the MBA program at ITM Navi Mumbai are approximately ₹10 lacs for the two-year duration. This fee includes tuition, course materials, and access to campus facilities.",
      },
    },
    {
    ...
    faqHTML += `
      <div class="accordion-item mb-3">
        <button
          ...
          data-index="${index}">
          <span class="font-Bebas-Neue text-lg md:text-xl">${faq.question}</span>
